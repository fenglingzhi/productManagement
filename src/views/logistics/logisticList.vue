        ...
        <div>
            ...
            <a-table :columns="columns"
              ...
              <span slot="action" slot-scope="text, record">
                  <a @click="editAttribute(text.carrier_id)">修改</a>
                  <a-divider type="vertical"></a-divider>
                  <a @click="deleteProduct(text.carrier_id)">删除</a>
              </span>
...
<script>
    ...
    const columns = [
        ...
        { title: '物流名称', dataIndex: 'name', key: 'name'},
        { title: '最小', dataIndex: 'c_min', key: 'c_min'},
        { title: '最大', dataIndex: 'c_max', key: 'c_max'},
        { title: '运费', dataIndex: 'shipping_price', key: 'shipping_price'},
    ...
    export default {
        ...
        ,submitEdit() {
            ...
            ,getList(data){
                this.loading = true;
                this.$post('/carrier/getCarrierListPage',data).then((reData)=>{
