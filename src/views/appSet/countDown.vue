  ...
  data() {
    return {
      columns: [
        ...
        { title: "开始时间", dataIndex: "start_stamp", key: "start_stamp" },
        { title: "结束时间", dataIndex: "end_stamp", key: "end_stamp" },
    ...
    getList() {
      ...
      this.$post(
        ...
        arr.forEach(element => {
          ...
          element.start_stamp = this.timeParse(element.start_stamp);
          element.end_stamp = this.timeParse(element.end_stamp);
        });
