            ...
            <a-col class="gutter-row" :span="3">
                <a-row>
                    <a-col class="gutter-row" :offset="12" :span="12">
                        <a-button type="primary" v-show="!$store.state.isEdit"  @click="saveProductInfor()">保存</a-button>
                        <a-button type="primary" v-show="$store.state.isEdit"  @click="saveEiderInfor()">保存</a-button>
                    </a-col>
                </a-row>
            </a-col>
        </div>
        <a-row>
            <a-col class="gutter-row" v-show="!$store.state.isEdit" :span="6">
                <div class="inputPart">
