                    ...
                    <a-col class="gutter-row" :span="6">
                        <div class="inputPart">
                            ...
                            <a-col class="gutter-row" :span="16" style="line-height: 30px">
                                <a-radio-group v-if="!this.$store.state.isEdit" @change="onChangeIsUse" name="radioGroup" :defaultValue="0">
                                    <a-radio :value="1">启用</a-radio>
                                    <a-radio :value="0">禁止</a-radio>
                                </a-radio-group>
                                {{this.$store.state.oldData.prdBase.active}}
                                <a-radio-group v-if="this.$store.state.isEdit" @change="onChangeIsUse" name="radioGroup" :defaultValue="this.$store.state.oldData.prdBase.active">
                                    <a-radio :value="1">启用</a-radio>
                                    <a-radio :value="0">禁止</a-radio>
                                </a-radio-group>
    ...
    export default {
        ...
        mounted() {
            ...
            if(this.$store.state.isEdit){
                ...
                this.postData.product_type = Data.product_type.toString()
